...
export const csHistoryRecords: CsHistoryRecord[] = [
  { id: 1, happenedAt: '2026-03-17 오후 3:41:16', customerName: '고준석', orderNo: '셀-S260106133213', worker: 'sbkim', type: '배송중분실로인한생성', status: '처리완료', memo: '(분실주문생성) [memo] 배송중 분실테스트' },
  { id: 2, happenedAt: '2026-03-17 오후 3:41:16', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '10.배송중분실', status: '처리완료', memo: '배송중 분실테스트' },
  { id: 3, happenedAt: '2026-03-17 오후 3:38:55', customerName: '고준석(맞교환)', orderNo: '셀-S260106133213', worker: 'sbkim', type: '12.품절취소', status: '처리완료' },
  { id: 4, happenedAt: '2026-03-17 오후 3:38:43', customerName: '고준석(맞교환)', orderNo: '셀-S260106133213', worker: 'sbkim', type: '취소복구', status: '처리완료' },
  { id: 5, happenedAt: '2026-03-17 오후 3:33:12', customerName: '고준석(맞교환)', orderNo: '셀-S260106133213', worker: 'sbkim', type: '05.발송전취소', status: '처리완료' },
  { id: 6, happenedAt: '2026-03-17 오후 3:32:52', customerName: '고준석(맞교환)', orderNo: '셀-S260106133213', worker: 'sbkim', type: '취소복구', status: '처리완료' },
  { id: 7, happenedAt: '2026-03-17 오후 3:27:56', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '취소복구', status: '처리완료' },
  { id: 8, happenedAt: '2026-03-17 오후 1:28:32', customerName: '고준석', orderNo: '셀-S260106133213', worker: 'sbkim', type: '배송지수정', status: '처리완료', memo: '추가묶음체크에 묶어주기를 통해 주소를 203호로 변경함.' },
  { id: 9, happenedAt: '2026-03-17 오후 1:28:32', customerName: '고준석', orderNo: '셀-S260106133213', worker: 'sbkim', type: '01.일반상담', status: '처리완료', memo: '추가묶음체크에 묶어주기를 통해 수령자를 고준석(맞교환) -> 고준석 변경함.' },
  { id: 10, happenedAt: '2026-03-17 오후 1:28:32', customerName: '고준석', orderNo: '셀-S260106133213', worker: 'sbkim', type: '01.일반상담', status: '처리완료', memo: '추가묶음체크에 묶어주기를 통해 수령자를 고준석(교환) -> 고준석 변경함.' },
  { id: 11, happenedAt: '2026-03-17 오후 12:09:45', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '반품완료', status: '처리완료', memo: '반품택배사 우체국택배, 반품회수일자 2026-03-16 확인.' },
  { id: 12, happenedAt: '2026-03-17 오후 12:08:01', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '취소복구', status: '처리완료' },
  { id: 13, happenedAt: '2026-03-17 오전 11:58:59', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '반품회수취소', status: '처리완료', memo: '회수일자 2026-03-16 반품회수확인 취소.' },
  { id: 14, happenedAt: '2026-03-17 오전 11:54:13', customerName: '고준석', orderNo: '셀-S260106133213', worker: 'sbkim', type: '미배송으로인한생성', status: '처리완료', memo: '(미배송생성) [금액변경] [3000] -> [0]' },
  { id: 15, happenedAt: '2026-03-17 오전 11:54:13', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '14.미배송', status: '처리완료', memo: '미배송처리' },
  { id: 16, happenedAt: '2026-03-17 오전 11:52:09', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '취소복구', status: '처리완료' },
  { id: 17, happenedAt: '2026-03-17 오전 11:46:32', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '맞교환완료', status: '처리완료', memo: '(맞교환완료) 2026.03.16 교환회수확인 완료.' },
  { id: 18, happenedAt: '2026-03-17 오전 11:46:32', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '교환으로인한취소', status: '처리완료', memo: '맞교환으로 인한 취소' },
  { id: 19, happenedAt: '2026-03-17 오전 11:38:05', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '맞교환요청', status: '처리완료', memo: '(맞교환요청) 그린,XL -> 화이트,L 변경 / 금액 3000 -> 0 / 맞교환주문생성' },
  { id: 20, happenedAt: '2026-03-17 오전 11:38:05', customerName: '고준석', orderNo: '셀-S260106133213', worker: 'sbkim', type: '교환으로인한생성', status: '처리완료', memo: '이 주문은 교환으로 인하여 생성된 주문입니다.' },
  { id: 21, happenedAt: '2026-03-17 오전 11:37:32', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '취소복구', status: '처리완료' },
  { id: 22, happenedAt: '2026-03-17 오전 10:26:06', customerName: '고준석', orderNo: '셀-S260106133213', worker: 'sbkim', type: '교환으로인한생성', status: '처리완료', memo: '이 주문은 교환으로 인하여 생성된 주문입니다.' },
  { id: 23, happenedAt: '2026-03-17 오전 10:26:04', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '교환완료', status: '처리완료', memo: '(교환완료) 교환회수확인 후 주소를 202호로 반영.' },
  { id: 24, happenedAt: '2026-03-17 오전 10:26:04', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '교환으로인한취소', status: '처리완료', memo: '교환으로 인한 취소 [반품회수수량 3]' },
  { id: 25, happenedAt: '2026-03-17 오전 10:22:19', customerName: '고준석', orderNo: 'S260106133213', worker: 'sbkim', type: '교환요청', status: '처리완료', memo: '(교환요청) 우체국택배 반품정보 접수.' },
]
