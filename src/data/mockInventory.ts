...
export const mockInventoryItems: InventoryItem[] = [
  ...
  { sku: 'SKU-0030', name: '에어맥스 270', category: '의류/신발', zone: 'B', rack: '03', bin: '04', currentQty: 130, safetyQty: 60, status: 'normal', lastMovedAt: '2026-02-26' },
  { sku: 'SKU-0031', name: '에어포스1', category: '의류/신발', zone: 'B', rack: '03', bin: '05', currentQty: 85, safetyQty: 60, status: 'normal', lastMovedAt: '2026-02-26' },
  ...
  { sku: 'SKU-0120', name: '여성 재킷', category: '의류/신발', zone: 'C', rack: '03', bin: '01', currentQty: 47, safetyQty: 30, status: 'normal', lastMovedAt: '2026-02-26' },
  ...
  { sku: 'SKU-0150', name: '990v5', category: '의류/신발', zone: 'B', rack: '05', bin: '03', currentQty: 78, safetyQty: 40, status: 'normal', lastMovedAt: '2026-02-20' },
  ...
  { sku: 'SKU-0210', name: '러닝화 남성', category: '의류/신발', zone: 'B', rack: '06', bin: '01', currentQty: 65, safetyQty: 40, status: 'normal', lastMovedAt: '2026-02-19' },
