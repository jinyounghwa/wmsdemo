      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="bg-[#1e293b] rounded-xl border border-slate-700/50 p-5 space-y-3">
            ...
            <button
              onClick={() => upsertRule({ customer, palletStorageRate, cbmStorageRate, inboundFee, outboundFee, packagingFee })}
          ...
          <div className="bg-[#1e293b] rounded-xl border border-slate-700/50 p-5 space-y-3">
            ...
            <button
              onClick={() => generateBill({ month, customer, palletDays, cbmDays, inboundCount, outboundCount, packagingCount })}
          ...
          <div className="bg-[#1e293b] rounded-xl border border-slate-700/50 overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                {records.length === 0 && (
                  <tr>
                    <td colSpan={2} className="text-center py-8 text-slate-500">생성된 정산 데이터가 없습니다.</td>
                  </tr>
                )}
              </tbody>
            </table>
