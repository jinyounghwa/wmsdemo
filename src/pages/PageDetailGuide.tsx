...
const domainById: Record<string, { ko: string; en: string }> = {
  ...
  'shipping-post-process': { ko: '송장 삭제/스캔 오류/남은 송장 정리', en: 'Waybill deletion, scan-error correction, and floating-waybill cleanup' },
  ...
  'cs-management': { ko: '주문별 CS 현황/히스토리/메모', en: 'Order CS overview, history, and memos' },
...
const titleOverrideById: Record<string, { ko: string; en: string }> = {
  ...
  'cs-management': { ko: 'CS 관리', en: 'CS Management' },
