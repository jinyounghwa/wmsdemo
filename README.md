...
- 패션 WMS 특화
  - 스타일-컬러-사이즈 매트릭스 SKU 일괄 생성, 사이즈 런 템플릿
  - 시즌/컬렉션(SS/FW) 기반 재고 추적 및 시즌 소진율/이월률 리포트
  - B2B(박스/패킹리스트) vs B2C(낱개/택배) 출고 분기, 사전배분/촬영샘플 플래그
  - 반품 A/B/C/폐기 등급 분류, 검수 항목(택 제거/오염) 기록
  - VAS(택 부착/다림질/기프트랩) 단가/건수/정산 반영
- 운영 고도화 모듈
